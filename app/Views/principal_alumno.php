...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="https://www.angulo7.com.mx/wp-content/uploads/2018/01/BUAP-bienvenida-nuevo-ingreso.jpg" width="100%">
            </div>
            <div class="col-md-8 project-details">
                <h3>Sobre el Proyecto</h3>
                <p>El Area BUAP es una plataforma diseñada para facilitarte la solicitud de laboratorios y equipos necesarios para tus proyectos e investigaciones en la Benemérita Universidad Autónoma de Puebla (BUAP).</p>
