...
<div class="w3-container">
    ...
    <a href="<?= base_url('alta_capacitacion'); ?>"> Agrega una capacitacion</a><br>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td><?= $dato['estado']; ?></td>
                <td><a href="<?= base_url('borrar_capacitacion/'.$dato['idcapacitacion']); ?>"><i class="fa fa-trash"></i></a></td>
                <td><a href="<?= base_url('editar_capacitacion/'.$dato['idcapacitacion']); ?>"><i class="fa fa-pencil"></i></a></td>
            </tr>
            <?php endforeach; ?>
<?php endif; ?>
        </table>
